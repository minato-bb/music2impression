...
def movie2impression():
    color_image_scale = pd.read_csv("/Users/babaminato/music2impression/Data/csv/color_img_scale.csv", index_col="Unnamed: 0")
    color_ = pd.read_csv('/Users/babaminato/music2impression/Data/csv/color.csv', index_col='Hue/Tone')
    color = color_.drop(["color","h", "s", "v", "L", "a", "b"], axis =1)

    image_path = "/Users/babaminato/music2impression/Data/Img/"
    dir_name = os.listdir(image_path)

    target_dir ='/Users/babaminato/music2impression/Data/Img/frame/'
